...
namespace Validators.Tests.Clients.Register
{
    public class RegisterClientsValidatorTests
    {
        ...
        public void Error_Name_Empty(string name)
        {
            ...
            //Assert
            Assert.Contains(ResourceErrorMessages.REQUIRED_NAME, exception.Errors);
        }
        ...
        public void Area_Of_Activity_Invalid()
        {
            ...
            //Assert
            Assert.Contains(ResourceErrorMessages.AREA_OF_ACTIVITY, exception.Errors);
        }
        ...
        public void Error_Amount_Charged(decimal amount)
        {
            ...
            //Assert
            Assert.Contains(ResourceErrorMessages.AMOUNT_CHARGED, exception.Errors);
        ...
        public void Description_Error(string description)
        {
            ...
            //Assert
            Assert.Contains(ResourceErrorMessages.SERVICE_DESCRIPTION, exception.Errors);
        }
